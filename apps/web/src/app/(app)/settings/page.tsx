...
import { User, Building2, Users, Zap, Bell, ScrollText } from "lucide-react";
...
const settingsSections = [
  ...
  { href: "/settings/audit-log", title: "Audit Log", description: "Review all create, update, and delete actions", icon: ScrollText },
];
